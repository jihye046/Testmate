...
## ✨ Project Preview
**Testmate**는 교육 콘텐츠 관리의 비효율성을 해결하기 위한 통합 솔루션입니다.
단순 문제 풀이를 넘어 **PDF 자동 파싱 기술**과 **데이터 무결성 검증 대시보드**를 통해 교육 데이터의 디지털화 및 정합성 관리 자동화를 구현합니다.
...
## ⚖️ License
© 2026 Jihye. All Rights Reserved.
